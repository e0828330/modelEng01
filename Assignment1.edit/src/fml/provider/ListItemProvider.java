...
/**
 * This is the item provider adapter for a {@link fml.List} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ListItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FmlPackage.Literals.LIST__IS_ORDERED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FmlPackage.Literals.LIST__CONSISTS);
		}
	...
	public String getText(Object object) {
		Integer labelValue = ((fml.List)object).getID();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(fml.List.class)) {
			case FmlPackage.LIST__IS_ORDERED:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case FmlPackage.LIST__CONSISTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FmlPackage.Literals.LIST__CONSISTS,
