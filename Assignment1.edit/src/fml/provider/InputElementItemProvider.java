...
/**
 * This is the item provider adapter for a {@link fml.InputElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InputElement_isMandatory_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InputElement_isMandatory_feature", "_UI_InputElement_type"),
				 FmlPackage.Literals.INPUT_ELEMENT__IS_MANDATORY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Integer labelValue = ((InputElement)object).getID();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InputElement.class)) {
			case FmlPackage.INPUT_ELEMENT__IS_MANDATORY:
