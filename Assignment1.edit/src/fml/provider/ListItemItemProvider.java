...
/**
 * This is the item provider adapter for a {@link fml.ListItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ListItemItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ListItem_Text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ListItem_Text_feature", "_UI_ListItem_type"),
				 FmlPackage.Literals.LIST_ITEM__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Integer labelValue = ((ListItem)object).getID();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ListItem.class)) {
			case FmlPackage.LIST_ITEM__TEXT:
