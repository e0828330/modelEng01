 ...
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot oneWelcomePage='self.organized->select(p | p.isWelcome)->size() = 1 and self.organized.predecessor->isEmpty()' oneFirstPage='self.organized->select(p | p.predecessor->isEmpty())->size() = 1'"
 * @generated
 */
