...
public interface FmlPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int LIST_ITEM__CONTAINED = LIST__CONTAINED;
	 ...
	 * @ordered
	 */
	int LIST_ITEM__VISIBLE_IF_SELECTED = LIST__VISIBLE_IF_SELECTED;
	 ...
	 * @ordered
	 */
	int LIST_ITEM__IS_ORDERED = LIST__IS_ORDERED;
	 ...
	 * @ordered
	 */
	int LIST_ITEM__CONSISTS = LIST__CONSISTS;
	 ...
	 * @ordered
	 */
	int LIST_ITEM__TEXT = LIST_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int LIST_ITEM_FEATURE_COUNT = LIST_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int LIST_ITEM_OPERATION_COUNT = LIST_OPERATION_COUNT + 0;
