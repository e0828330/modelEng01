...
public class FmlValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	protected static final String FORM__ONE_WELCOME_PAGE__EEXPRESSION = "self.organized->select(p | p.isWelcome)->size() = 1 and self.organized->select(p | p.isWelcome)->forAll(p | p.predecessor->isEmpty())";
	...
	public boolean validateSelectField(SelectField selectField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateSelectField_RadioOnlyOneSelected(selectField, diagnostics, context);
		return result;
	}

	/**
	 * The cached validation expression for the RadioOnlyOneSelected constraint of '<em>Select Field</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public boolean validateSelectField_RadioOnlyOneSelected(SelectField selectField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(FmlPackage.Literals.SELECT_FIELD,
				 selectField,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "RadioOnlyOneSelected",
				 SELECT_FIELD__RADIO_ONLY_ONE_SELECTED__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
